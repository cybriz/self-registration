...
var CongratzPageComponent = /** @class */ (function () {
    function CongratzPageComponent() {
    }
    CongratzPageComponent.prototype.ngOnInit = function () { };
    CongratzPageComponent.prototype.ngAfterViewInit = function () { };
    CongratzPageComponent.prototype.ngOnDestroy = function () { };
...
var SetupAccountComponent = /** @class */ (function () {
    function SetupAccountComponent(fb, http, route, router, service) {
        var _this = this;
        this.fb = fb;
        this.http = http;
        this.route = route;
        ...
        this.route.queryParams.subscribe(function (itm) {
            _this.queryParamsData = itm;
        });
    }
    ...
    SetupAccountComponent.prototype.ngAfterViewInit = function () { };
    SetupAccountComponent.prototype.ngOnDestroy = function () { };
    SetupAccountComponent.prototype.setup = function () {
        console.log(this.formGrp.value);
        console.log(this.formGrp.valid);
        var data = this.formGrp.value;
        var object = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.queryParamsData, data);
        this.router.navigate(['/setup-admin'], { queryParams: object });
    };
    SetupAccountComponent.ctorParameters = function () { return [
...
var SetupAdminComponent = /** @class */ (function () {
    function SetupAdminComponent(fb, http, route, router, service) {
        var _this = this;
        this.fb = fb;
        this.http = http;
        this.route = route;
    ...
    SetupAdminComponent.prototype.ngOnInit = function () {
        this.formGrp = this.fb.group({
    ...
    SetupAdminComponent.prototype.ngAfterViewInit = function () { };
    SetupAdminComponent.prototype.ngOnDestroy = function () { };
    SetupAdminComponent.prototype.done = function () {
        var data = this.formGrp.value;
    ...
    SetupAdminComponent.prototype.createFreemiumAccount = function (data) {
        var url = 'https://graph.symple.my/license';
        return this.http
            .post(url, data)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.onError));
    };
    SetupAdminComponent.prototype.onError = function (err) {
        var errorMessage = err;
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["throwError"])(errorMessage);
    };
    SetupAdminComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
...
var SignUpComponent = /** @class */ (function () {
    ...
    SignUpComponent.prototype.save = function (data) {
...
var TenantValidators = /** @class */ (function () {
    function TenantValidators(http) {
        this.http = http;
    }
    TenantValidators.prototype.searchTenant = function (name) {
        var _this = this;
        // debounce
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["timer"])(500)
            ...
            return _this.http.get("https://graph.symple.my/license/check-tenant/" + name);
        }));
    };
    TenantValidators.prototype.tenantValidator = function () {
        var _this = this;
        return function (control) {
            return _this.searchTenant(control.value)
    ...
    TenantValidators.ctorParameters = function () { return [
...
var UsernameValidators = /** @class */ (function () {
    function UsernameValidators(http) {
        this.http = http;
    }
    UsernameValidators.prototype.searchUser = function (name) {
        var _this = this;
        // debounce
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["timer"])(500)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function () {
            // Check if username is available
            return _this.http.get("https://graph.symple.my/license/check-username/" + name);
        }));
    };
    UsernameValidators.prototype.usernameValidator = function () {
        var _this = this;
        return function (control) {
            return _this.searchUser(control.value)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
    ...
    UsernameValidators.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var ValidationService = /** @class */ (function () {
    ...
    ValidationService.alpaNumValidator = function (control) {
    ...
    ValidationService.decimalValidation = function (control) {
